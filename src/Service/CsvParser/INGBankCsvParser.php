...
/**
 * Przykładowy plik CSV z ING Bank zawiera takie kolumny:
 ...
 * 
 */
class INGBankCsvParser extends CsvParser
{

    public const COL_DATA_KSIEGOWANIA = 1;
    public const COL_KWOTA = 8;
    public const COL_KONTRAHENT = 2;
    public const COL_TYTUL = 3;
    public const COL_RACHUNEK_KONTRAHENTA = 4;
    public const DATA_OFFSET = 20;
    public const NUMBER_OF_COLUMNS = 21;
    ...
    {
        return iconv('windows-1250', 'utf-8', $line);
    }
